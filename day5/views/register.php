...
<body>
    <div class="container py-4" style="max-width: 700px;">
        ...
        <div class="mb-3 d-flex flex-wrap gap-2">
            ...
            <a href="index.php?action=login" class="btn btn-outline-secondary btn-sm">Login</a>
        ...
        <form id="registerForm" method="post" action="index.php?action=registerStore" enctype="multipart/form-data" novalidate>
            <div class="mb-3">
